...
void main() {
  group('Flutter Driver demo', ()
  {
    ...
    test('Publicar_Viaje', () async {

      await driver.waitFor(find.byValueKey('crear_viaje'));
      await driver.tap(find.byValueKey('crear_viaje'));

      await driver.waitFor(find.byValueKey('pestaña_viaje'));

      await driver.tap(find.byValueKey('añadir_viaje'));

      await driver.tap(find.byValueKey('ciudad_origen'));
