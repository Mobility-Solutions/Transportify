  ...
  group('BuscarPaquete Test', () {
    ...
    test('BuscarPaquete', () async {
      ...
      await driver.tap(buscarBotonFinder);
       ...
       final listFinder = find.byValueKey('listaPaquetes');
      final paqueteBuscadoFinder = find.byValueKey("paquete_0_Buscado");
      final timeline = await driver.traceAction(() async {
        await driver.scrollUntilVisible(
          listFinder,
          paqueteBuscadoFinder,
          dyScroll: -300.0,
        );

        expect(await driver.getText(paqueteBuscadoFinder), 'paquete_0_Buscado');
      });
